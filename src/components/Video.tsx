//biblioteca dos icones do Phosphor
import { CaretRight, DiscordLogo, FileArrowDown, Lightning } from "phosphor-react";
//biblioteca utilizada para renderizar os videos na tela do site
import { DefaultUi, Player, Youtube } from "@vime/react";

//estiliriza o css dos controles de reprodução
    ...
    <div className="flex-1">
        <div className="bg-black flex justify-center">
            <div className="h-full w-full max-w-[1100px] max-h-[68vh] aspect-video">
                {/* controla a exibição */}
                <Player>
                    {/* Diz de onde o video será puxado */}
                    <Youtube videoId={data.lesson.videoId}></Youtube>
                    {/* Define os controles de reprodução */}
                    <DefaultUi/>
                </Player>
            </div>
        </div>
